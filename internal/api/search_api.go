...
func (c *Client) IndexZoomHistogramLv3(searchString string, rangeFrom, rangeTo int64) (*model.ElasticSearchResult, error) {
	svc := fluencyAPI.NewSearchService(c.fluencyClient)
	resp, err := svc.IndexZoomHistogramLv3(searchString, rangeFrom, rangeTo)
	if err != nil {
